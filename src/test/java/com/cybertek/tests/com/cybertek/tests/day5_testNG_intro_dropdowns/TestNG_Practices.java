package com.cybertek.tests.com.cybertek.tests.day5_testNG_intro_dropdowns;
...
public class TestNG_Practices {
    ...
    public void setUpMethod() {
        ...
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);//it will wait up 15 seconds
        //1- Go to google
