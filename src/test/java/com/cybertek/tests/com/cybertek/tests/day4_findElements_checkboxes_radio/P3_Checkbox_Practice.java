package com.cybertek.tests.com.cybertek.tests.day4_findElements_checkboxes_radio;
...
public class P3_Checkbox_Practice {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement homeLink = driver.findElement(By.xpath("//a[.='Home']"));////a[@class='nav-link']//or //a[@href='/']
